        ...
        success: function(data){
            ...
            if(data.success)
            {
                $('#crudForm').ajaxSubmit({
                    ...
                    success: function(result){
                        ...
                        if(data.success)
                        {
                            if(save_and_close)
                            {
                                ...
                                let _url = url.substring(0, url.lastIndexOf('/'));
                    ...
                    error: function(e){
                        var error = unescapeSlashes(e.responseText);
                        alert_message('error', error.error_message.replace(/(\&lt\;\/p\&gt\;)*/g,""));
                    }
                });
            }
            else
...
function unescapeSlashes(yourjson) {
    var jsontemp = yourjson.replace(/(<\/p>)*/g,"").replace(/(<p>)*/g,"").replace(/(&lt;\/p&gt;)*/g,"");
