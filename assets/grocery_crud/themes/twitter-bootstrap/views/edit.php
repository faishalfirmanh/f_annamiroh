...
<div class="twitter-bootstrap crud-form">
	...
	<h2 style="margin-bottom: 30px" class="span12"><?php echo $this->l('form_edit'); ?> <?php echo $subject?></h2>
	...
	<div id="main-table-box span12">
		...
		echo form_open( $update_url, 'method="post" id="crudForm" class="form-div span12" autocomplete="off" enctype="multipart/form-data"');
			...
			<input id="save-and-go-back-button" type="button" value="<?php echo $this->l('form_update_changes'); ?>" class="btn btn-large btn-primary submit-form"/>
