...
<div class="twitter-bootstrap">
	...
	<h3 class="span12"><?php echo $subject ?></h3>
	<?php if(isset($warning)){ ?> <h5 style="float:right; color: red;"><?php echo $warning ?></h5><?php } ?>
		<br/>
		...
		<div id="options-content" class="span12">
			...
			if(!$unset_add || !$unset_export || !$unset_print){?>
				...
				if(!$unset_add){?>
	 			...
	 			if(!$unset_export) { ?>
		 			<a class="export-anchor btn btn-success" data-url="<?php echo $export_url; ?>" rel="external">
			...
			<?php if($import) { ?>
			<a class="print-anchor btn btn-danger" href="<?php echo $import; ?>">
				<i class="icon-upload icon-white"></i>
				<span>Import</span>
		 	</a>
			<?php } ?>
 			<a class="btn btn-warning" data-toggle="modal" href="#filtering-form-search" >
