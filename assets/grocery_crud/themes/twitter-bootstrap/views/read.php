...
<div class="twitter-bootstrap crud-form">
			<h2 style="margin-bottom: 30px" class="span12">
			...
			<div id="main-table-box span12">
				<?php
				echo form_open( $read_url, 'method="post" id="crudForm" class="form-div span12" autocomplete="off" enctype="multipart/form-data"');
