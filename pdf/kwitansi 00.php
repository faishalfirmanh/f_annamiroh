...
// Query untuk merelasikan kedua tabel
	...
	$terbilang=num_to_words($jmlh, '', 0, '').' rupiah';
	$nominal = uang($jmlh);
...
$pdf->ezText("\n\n\n\n       Nama Jamaah			   	 		:{$nama_jamaah}                        No Porsi       :{$no_porsi}");
$pdf->ezText("       Alamat Jamaah				    :{$alamat_jamaah}   No Kwitansi		  :{$id_pembayaran}");
$pdf->ezText("\n\n   				Untuk Pembayaran				 :$untuk");
$pdf->ezText("   				Tanggal Pembayaran			:{$tgl_bayar}");
$pdf->ezText("\n\n\n       Nominal				          :Rp. {$nominal}");
...
array('xPos'=>50,'xOrientation'=>'right','width'=>500,'showLines'=>0,'shaded'=>0,'cols'=>array(
'name'=>array('width'=>250, 'justification'=>'center')
