...
<input type="hidden" class="form_field" name="id_th" size="30" value="<?php echo set_value('id_th', isset($default['id_th']) ? $default['id_th'] : ''); ?>" />

	<p>
		<label for="tgl_debet">Tgl Debet :</label>
		<input type="text" class="validate(date)" id="tgl_debet" name="tgl_debet" size="10" maxlength="10" value="<?php echo set_value('tgl_debet', isset($default['tgl_debet']) ? $default['tgl_debet'] : ''); ?>" />
	</p>
	<?php echo form_error('tgl_debet', '<p class="field_error">', '</p>');?>
	...
	<p>
		...
		<input type="button" id="button" name="batal" onclick="window.location='<?=base_url()?>index.php/onh/debet';" value="Batal" />
	</p>
</form>
<?php
	if ( ! empty($link))
