...
<form name="kbih_form" id="kbih_form" method="post" action="<?=$form_action?>">
<input type="hidden" class="form_field" name="id_kbih" size="30" value="<?php echo set_value('id_kbih', isset($default['id_kbih']) ? $default['id_kbih'] : ''); ?>" />
	<p>
	...
	<p>
		...
		<input type="submit" name="submit" id="submit" value=" Simpan " /> <input type="button" id="button" name="batal" onclick="window.location='<?=base_url()?>index.php/kbih';" value="Batal" />
	</p>
</form>
<?php
	if ( ! empty($link))
