...
<input type="hidden" class="form_field" name="id_adm" size="30" value="<?php echo set_value('id_adm', isset($default['id_adm']) ? $default['id_adm'] : ''); ?>" />
	<p>
	...
	<p>
		...
		<input type="text" class="validate(required)" name="keterangan" id="keterangan" value="<?php echo set_value('keterangan', isset($default['keterangan']) ? $default['keterangan'] : ''); ?>" />
	...
	<p>
		...
		<input type="submit" name="submit" id="submit" value=" Simpan " /> <input type="button" id="button" name="batal" onclick="window.location='<?=base_url()?>index.php/adm';" value="Batal" />
	</p>
</form>
<?php
	if ( ! empty($link))
