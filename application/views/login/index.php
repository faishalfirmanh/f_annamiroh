...
<head>
  <meta charset="UTF-8">
  <title>PT An Namiroh Travelindo - Login</title>
    ...
    <div class="login">
      ...
      <div class="login__form">
        <div class="login__row">
          ...
          <input type="text" name="username" size="20" class="login__input name" placeholder="Username"/>
        </div>
        <div class="login__row">
          <svg class="login__icon pass svg-icon" viewBox="0 0 20 20">
            <path d="M0,20 20,20 20,8 0,8z M10,13 10,16z M4,8 a6,8 0 0,1 12,0" />
          </svg>
          <input type="password" name="password" size="20"class="login__input pass" placeholder="Password"/>
        </div>
        <button type="button" class="login__submit">Sign in</button>
        <p class="login__signup">Belum memiliki Akun? &nbsp;<a>Daftar</a></p>
      </div>
    </div>
    <div class="app">
      <div class="app__top">
        ...
        <p class="app__hello">Assalamu'alaikum!</p>
        <div class="app__user">
