...
<head>
    ...
    <title>Sistem Informasi Agen</title>
    <meta name="description" content="PT An Namiroh Travelindo">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
					...
					foreach($menu1 as $m){
                        ...
                        <a href="'.base_url($m->link).'"> <i class="menu-icon '.$m->style.'"></i>'.$m->menu.'</a>
                        
                    </li>';					
					// foreach($menu1 as $m){
						// echo '<li class="menu-icon">
                        // <a href="'.base_url($m->link).'" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon '.$m->style.'"></i>'.$m->menu.'</a>
