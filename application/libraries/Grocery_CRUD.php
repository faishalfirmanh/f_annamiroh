...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected function showList($ajax = false, $state_info = null)
	{
		...
		$data->is_invoice			= $this->is_invoice;
		$data->exceptions		    = $this->exceptions;
		$data->is_collective_transaction			= $this->is_collective_transaction;
		$data->is_payment_collective_transaction			= $this->is_payment_collective_transaction;
		$data->footer				= $this->footer;
		$data->import				= $this->import;
		$data->data_receiver		= $this->data_receiver;
	...
	protected function showAddForm($validation = null)
	{
		$this->set_js_lib($this->default_javascript_path.'/'.grocery_CRUD::JQUERY);

		$data 					= $this->get_common_data();
		$data->types 			= $this->get_field_types();
		$data->error_message    = isset($validation->error_message) ? $validation->error_message : "TEST";
...
class Grocery_CRUD extends grocery_CRUD_States
{
	...
	protected $is_invoice			= false;
	protected $is_collective_transaction = false;
	protected $is_payment_collective_transaction = false;
	protected $exceptions = [];
	protected $data_receiver		= null;
	...
	public function set_data_receiver($data_receiver){
	...
	public function set_is_invoice($is_invoice){
	...
	public function set_is_collective_transaction($is_collective_transaction){
		$this->is_collective_transaction = $is_collective_transaction;

		return $this;
	}

	public function set_is_payment_collective_transaction($is_payment_collective_transaction){
		$this->is_payment_collective_transaction = $is_payment_collective_transaction;
	...
	public function render($extra = null)
	{
		...
		switch ($this->state_code) {
			...
			case 2://add
				...
				$this->set_basic_Layout();
				$validation_result = $this->db_insert_validation();
				$this->showAddForm($validation_result);
