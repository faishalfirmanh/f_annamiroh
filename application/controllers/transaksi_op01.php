...
class Transaksi_Op extends CI_Controller {
	...
	function pembayaran($paket=0,$jamaah =0){
		...
		elseif($jamaah==0){
			...
			->columns('jamaah','harga','kredit','kekurangan','debet','saldo','kode','agen');
	...
	*/
	function debet($id=0){
		...
		$saldo = $kredit - $debet;
		$this->crud
		->set_subject("Transaksi Debet $jamaah | Paket :$paket | Harga:$harga | Pembayaran:$kredit | Kekurangan: ".$kurang."<br>Transaksi Debet : $debet | saldo = $saldo")
		->set_top("Transaksi Debet $jamaah | Paket :$paket | Harga:$harga | Pembayaran:$kredit | Kekurangan: ".$kurang."<br>Transaksi Debet : $debet | saldo = $saldo");
