...
class Master extends CI_Controller {
	...
	function jamaah($paket=0){
		...
		$this->crud->fields('nama_jamaah','tgl_lahir','alamat_jamaah','no_tlp','hp_jamaah','no_ktp','foto','kartukeluarga','ktp','surat_nikah','keterangan','paket','agen');
		$this->crud->columns('nama_jamaah','tgl_lahir','no_ktp','agen','hp_jamaah','alamat','paket');
	...
	function paket_(){
		...
		$this->crud->set_relation('Penerbangan','data_maskapai','nama');
		$this->crud->set_subject('Data Paket Umroh');
	    $this->crud->columns('estimasi_keberangkatan','Program','Penerbangan','pembimbing','hotel_makkah','hotel_madinah','harga','sisa_kursi')->fields('estimasi_keberangkatan','Program','Penerbangan','hotel_makkah','hotel_madinah','pembimbing','harga','sisa_kursi')->unset_delete()->set_relation('pembimbing','data_jamaah_pembimbing','nama');
		$this->show();
	}
	function pembimbing(){
