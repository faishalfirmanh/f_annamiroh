...
class Master extends CI_Controller {
	...
	function jamaah($paket=0){
		...
		$this->crud->fields('nama_jamaah','title','place','age', 'passport','expired','issued','office','tgl_lahir','alamat_jamaah','no_tlp','hp_jamaah','no_ktp','foto','kartukeluarga','ktp','surat_nikah','keterangan','agen');
