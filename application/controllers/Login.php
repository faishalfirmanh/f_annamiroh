	...
	function process_login()
	{
		...
		if ($this->form_validation->run() == TRUE) {
			...
			if ($this->Login_model->check_user($username, $password) == TRUE) {
				...
				$data = array('id_admin' => $admin->id_admin, 'nama_level' => $admin->nama_level, 'username' => $username, 'nama_admin' => $admin->nama_admin, 'level' => $admin->level, 'login' => TRUE, 'fk' => $admin->fk, 'is_namiroh' => $admin->is_namiroh);
