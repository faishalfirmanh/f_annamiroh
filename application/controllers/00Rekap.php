...
class Rekap extends CI_Controller
{
	...
	var $transaksi_biaya_tambahan = array();   // <-- DAN INI JUGA
	...
	function get_details($master_id) {
        ...
        // $html_output .= '<div style="overflow-x: auto; display: block; width: 100%;">'; 

        // $html_output .= '<table class="table table-bordered table-sm">';
        
        
        
        $html_output .= '<div class="table-responsive">'; // Class Bootstrap yang menangani overflow
        // $html_output .= '<table class="table table-bordered table-sm" style="min-width:1400px;">'; 
        $html_output .= '<table class="table table-bordered table-sm" style="min-width:100%;">'; 
            // $html_output .= '<div style="overflow-x: auto; overflow-y: auto; width: 100%;">'; 
        ...
        $html_output .= '<th class="text-right">Harga Normal</th>'; // Kolom Baru
        ...
        $html_output .= '<th>Status Lunas</th>'; // Kolom Baru
        $html_output .= '<th>Permintaan Tambahan</th>';
        $html_output .= '</tr></thead>';
        $html_output .= '<tbody>';
        
        $no = 1;
        // Hitung colspan: 1 (No) + 1 (Nama) + 10 (Detail Transaksi) = 12
        $colspan = 12; 
            ...
            foreach ($jamaah_ids as $jamaah_id) {
                ...
                if ($rowspan_count > 0) {
                    foreach ($transaksi_list as $transaksi) {
                        // --- Ambil dan Format Data Baru & Lama ---
                        ...
                        // Format status_lunas menjadi badge
                        ...
                        $html_output .= '<td class="text-right">' . $harga_normal . '</td>'; // Kolom Baru
                        ...
                        $html_output .= '<td>' . $status_lunas_badge . '</td>'; // Kolom Baru
	...
	*/
	...
	function get_details($master_id) {
$jamaah_ids=
isset($this->paket_jamaah_ids[$master_id]) 
?$this->paket_jamaah_ids[$master_id] 
:
array();
$html_output="";
