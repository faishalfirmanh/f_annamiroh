...
class Umroh extends CI_Controller {
	...
	function cari_pembayaran(){
		...
		$crud->set_table('semua_data1')->columns('id_admin','nama','keterangan','tgl_bayar','nominal')->fields('id_admin','nama','keterangan','tgl_bayar');//
	...
	function get_jamaahnya(){
		...
		$crud->columns('nama_jamaah','no_porsi','tahun','id_status');
