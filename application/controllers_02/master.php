...
class Master extends CI_Controller {
	...
	function perhitungan(){
		...
		$this->crud->columns('keberangkatan', 'jual','jumlah_pax', 'tiket', 'visa', 'perlengkapan', 'handling', 'operasional', 'baksis', 'bus', 'guide','lama_guide' ,'hotel_makkah', 'hotel_madinah','jumlah_per_kamar', 
	...
	function jamaah($paket=0){
		...
		$this->crud->columns('nama_jamaah','paket','tgl_lahir','no_ktp','agen','hp_jamaah','alamat_jamaah');
	...
	//	$this->crud->set_relation('hotel','data_hotel','nama');
	    ...
	    $this->crud->columns('estimasi_keberangkatan','Program','Penerbangan','rute','hotel_makkah','hotel_madinah','harga','tanggal_keberangkatan','pembimbing','total_seat')->unset_delete()->set_relation('pembimbing','data_jamaah_pembimbing','nama');
		$this->show();
	}
	function paket_($arsip='1'){
		...
		$this->crud->set_relation('Penerbangan','data_maskapai','nama');
		$this->crud->set_subject('Data Paket Umroh');
	    $this->crud->columns('estimasi_keberangkatan','tanggal_keberangkatan','Program','Penerbangan','pembimbing','hotel_makkah','hotel_madinah','harga','total_seat','KET')->fields('estimasi_keberangkatan','tanggal_keberangkatan','Program','Penerbangan','hotel_makkah','hotel_madinah','pembimbing','harga','total_seat','KET')->unset_delete()->set_relation('pembimbing','data_jamaah_pembimbing','nama');
		$this->show();
	}
	function pembimbing(){
